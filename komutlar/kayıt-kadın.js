...
const kayıtlı = message.guild.roles.find(r => r.id === "809158363174797423"); // KADIN ROLÜNÜN İDSİ
...
const ikinci = message.guild.roles.find(r => r.id === "809158364042100777");
...
//------------------------------------------------KAYITLAR-----------------------------------------------\\    STG    
  ...
  let kadin = db.get(`kadinUye.${message.author.id}`);
